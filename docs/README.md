...
Judge จะให้คะแนน prompt ของคุณใน 5 มิติ รวม 100 คะแนน:

| มิติ | คะแนน | รายละเอียด |
|------|--------|------------|
| Role | 0–20 | กำหนด persona ชัดเจนแค่ไหน |
| Framework | 0–20 | ใช้กรอบวิเคราะห์ เช่น SWOT, Ikigai หรือไม่ |
| Task Breakdown | 0–20 | แบ่งขั้นตอนชัดเจนแค่ไหน |
| Empathy & Tone | 0–20 | สั่งให้ AI แสดงความเข้าอกเข้าใจหรือไม่ |
| Format | 0–20 | กำหนด output format ชัดเจนแค่ไหน |
